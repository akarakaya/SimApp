...
public class FutureQueue {
	...
	/** The sorted set. */
	private final SortedSet<SimEvent> sortedSet = Collections.synchronizedSortedSet(new TreeSet<SimEvent>());
	...
	public void addEvent(SimEvent newEvent) {
		...
		if (newEvent.getTag() == FogEvents.STOP_SIMULATION) {
			System.out.println("Evet Stop");
		}
