...
public class FogDevice extends PowerDatacenter {
	 ...
	 */
	private void updateModuleInstanceCount(SimEvent ev) { // burasi
	 ...
	 * @return the double
	 */
	protected double updateCloudetProcessingWithoutSchedulingFutureEventsForce() { // burasi onemli
	...
	protected void updateTimingsOnSending(Tuple resTuple) { // burasi onemli
	...
	protected void updateAllocatedMips(String incomingOperator){ // burasi
	...
	private void updateEnergyConsumption() { // burasi
	...
	int numClients=0;
	protected void processTupleArrival(SimEvent ev){ // burasi
	...
	protected void updateTimingsOnReceipt(Tuple tuple) { // burasi
