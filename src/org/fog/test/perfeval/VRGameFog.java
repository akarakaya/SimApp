...
public class VRGameFog {
	...
	static int numOfDepts = 4; // fog device sayisi
	static int numOfMobilesPerDept = 6; // sensor node sayisi ??
	static double EEG_TRANSMISSION_TIME = 5.1; // ECG iletim suresi icin bir deger belirle
	...
	public static void main(String[] args) {
		...
		try {
			...
			createFogDevices(broker.getId(), appId); // alttaki moduller ile cihazlar oludturulur
			
			// buraya kadar topoloji olusturulur
...
*/				moduleMapping.addModuleToDevice("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
			...
			controller.submitApplication(application, 0, 
					(CLOUD)?(new ModulePlacementMapping(fogDevices, application, moduleMapping))
							:(new MyModulePlacement(fogDevices, sensors, actuators, application, moduleMapping, "concentration_calculator"))); // task management kismi burada
	...
	private static void createFogDevices(int userId, String appId) {
		// FogDevice sinifindan gelen parametreler (9 tane -> )
		...
		for(int i=0;i<numOfDepts;i++){ // her bir gateway'e addGw ile bir fog device eklenir.
	...
	// alttaki createFogDevice metodu kullanilarak gateway olusturulur. proxy server ile level degerleri ayni
	...
	// alttaki createFogDevice metodu kullanilarak fog ve sensor, actuator ile uc cihazlar olusturulur
